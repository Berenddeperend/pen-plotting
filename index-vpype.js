...
async function createGCode() {
  ...
  // const vpype = `vpype --config configs/plotter.toml read svg/circles-3.svg penwidth 0.3mm occult -i scaleto 10cm 10cm layout 22x22cm translate 5cm 1cm gwrite -p plotter gcode/circles-a5.gcode`;
